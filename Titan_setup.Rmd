...
Java Runtime Environment (JRE) installed. You can check whether java is installed by opening the 'cmd' program on windows, or any shell on linux and typing: `java -version`. If java isn't installed then you can add it by doing: `sudo apt install default-jre` 
